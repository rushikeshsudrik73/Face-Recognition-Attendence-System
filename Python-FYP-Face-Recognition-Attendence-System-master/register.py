...
class Register:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"C:\Users\gauri\Documents\Python_Test_Projects\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\bgReg.jpg")
